...
<body>
  ...
  <nav>
      ...
      <ul>
          ...
          <li>
              <a class="active" href="ourpackages.php">Our Packages</a>
          </li>
          <li>
  ...
  <main>
    ...
    <h2 class="page-heading">RAJASTHAN PACKAGE</h2>
   
          
                <marquee behavior="scroll" direction="right" scrollamount="20">
                        <img src="./img/d6.jpg" width="520" height="320" />
                        <img src="./img/d2.jpg" width="520" height="320" />
                        <img src="./img/d3.jpg" width="520" height="320" /> 
                        <img src="./img/d4.jpg" width="520" height="320" />
                        <img src="./img/d5.jpg" width="520" height="320" />
                        <img src="./img/d1.jpg" width="520" height="320" />
                        <img src="./img/d6.jpg" width="520" height="320" />
                        <img src="./img/d2.jpg" width="520" height="320" />
                        <img src="./img/d3.jpg" width="520" height="320" /> 
                        <img src="./img/d4.jpg" width="520" height="320" />
...
<h3>Rs. 14,299</h3>
<h3>6 DAYS & 7 NIGHTS</h3>
         <p>

<p>Welcome to Rajasthan</p>
<p>
...
Time lapse of someone walking through the Bada Gumbad complex in Lodhi Gardens
Shraddha Gosavi / TripSavvy
...
<form action="insert.php" method="post">
         <strong>BOOK YOUR TRAVEL DATE:</strong> <input type="date" id="bdate" name="bdate">
         </p>
         <input type="submit" class="btn-readmore">
         </form>
         </div>
