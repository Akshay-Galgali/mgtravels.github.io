...
<body>
  ...
  <main>
    <h2 class="page-heading">KERALA PACKAGE</h2>
    <div id="post-container">
      <section id="blogpost">
          <div class="card-image"></div>
                <marquee behavior="scroll" s="right" scrollamount="30">
...
<form action="insert.php" method="post">
         BOOK YOUR TRAVEL DATE: <input type="date" id="bdate" name="bdate">
         </p>
